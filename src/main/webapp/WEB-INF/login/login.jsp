...
<meta charset="UTF-8">
<title>示例登陆页</title>
<link href="/situOA/src/main/webapp/layui/css/layui.css"
	rel="stylesheet">
<script type="text/javascript" src="/situOA/layui/layui.all.js"></script>
<style>
#win10-login {
	background: url('/situOA/common/image/wallpapers/login.jpg') no-repeat
		fixed;
	width: 100%;
	height: 100%;
	...
	<div id="win10-login">
		...
		<div id="win10-login-box">
			<div class="win10-login-box-square">
				<img src="/situOA/common/image/avatar.jpg" class="content" />
			</div>
			<p style="font-size: 24px; color: white; text-align: center">登录</p>
			<div id="tips"></div>
			<form method="post" action="/situOA/user/login">
				<!--用户名-->
