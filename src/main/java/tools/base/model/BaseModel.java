...
public class BaseModel extends PageLimit {
	...
	public BaseModel(String createTime, Integer createBy, Double order, String name, String code, Integer type) {
		super();
		this.createTime = createTime;
		this.createBy = createBy;
		this.order = order;
	...
	public BaseModel(String createTime, Integer createBy) {
		super();
		this.createTime = createTime;
		this.createBy = createBy;
	}
